...
FROM  (
  select ie.subject_id, ie.hadm_id, ie.icustay_id, date_trunc('day',ce.charttime) as charttime
  , case
  ...
  and ce.charttime between ie.intime and ie.intime + interval '30' day
