...
select
  ie.subject_id, ie.hadm_id, ie.icustay_id, vd.charttime_day as charttime
...
left join ventdurations vd
  ...
  (
    ...
    OR (vd.starttime >= ie.intime and vd.starttime <= ie.intime + interval '30' day)
  )
group by ie.subject_id, ie.hadm_id, ie.icustay_id, charttime
