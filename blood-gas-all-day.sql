...
( -- begin query that extracts the data
  ...
  -- this also fuses together multiple ITEMIDs containing the same data
    ...
    left join labevents le
      ...
      and le.charttime between (ie.intime - interval '6' hour) and (ie.intime + interval '30' day)
      and le.ITEMID in
      -- blood gases
      (
...
select pvt.SUBJECT_ID, pvt.HADM_ID, pvt.ICUSTAY_ID, date_trunc('day',pvt.CHARTTIME) as CHARTTIME
