...
select
  -- patient identifiers
  ie.subject_id, ie.hadm_id, ie.icustay_id, date_trunc('day',oe.charttime) as charttime_day
...
and oe.charttime between ie.intime and (ie.intime + interval '30' day) -- first ICU day
where itemid in
(
...
group by ie.subject_id, ie.hadm_id, ie.icustay_id, charttime_day
